---
title: Contributing to Cloud Pak for Integration Demos
description: Guide for contributing content to the Cloud Pak for Integration Demos
keywords: 'ibm,cam,install,cloud automation manager, cp4mcm'
---

<PageDescription>

Anyone can contribute to IBM Cloud Paks demos, whether you are an IBM'er or not.
